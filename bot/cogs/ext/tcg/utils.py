...
async def change_tcg_title_role(interaction: Interaction, member: discord.Member, current_tcg_role: Optional[discord.Role], current_elo: float) -> Optional[discord.Role]:
...
def check_for_eligible_tcg_title(interaction: Interaction, elo_rating: float) -> Optional[discord.Role]:
    """
